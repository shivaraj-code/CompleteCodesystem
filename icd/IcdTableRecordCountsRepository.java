...
public interface IcdTableRecordCountsRepository  extends JpaRepository<TableRecordCounts, Integer>{
	...
	@Query(value="select 1 as id, 'Existing Table' as table_name,count(*) as records_count from icdnew where (type='V' OR type='H') and status='Y' and version_state='Validated'"
			+ "union "
