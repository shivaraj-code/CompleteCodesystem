...
public class ServiceDescriptionUpdater {
    ...
    public void refreshSwaggerConfigurations() {
        ...
        discoveryClient.getServices().stream().filter(service -> service.contains("-service")).forEach(serviceId -> {
            ...
            if (serviceInstances == null || serviceInstances.isEmpty()) { //Should not be the case kept for failsafe
                ...
                if (jsonData.isPresent()) {
                    ...
                    definitionContext.addServiceDefinition(serviceId, jsonData.get());
                } else {
